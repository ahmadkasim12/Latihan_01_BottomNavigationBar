...
public class bd_persegi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bd_persegi);
        Vibrator v = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);

        et_input = findViewById(R.id.et_bd_persegi_input1);
        et_output = findViewById(R.id.et_bd_persegi_output);
        et_output_1 = findViewById(R.id.et_bd_persegi_output_1);

        Button btnBack = findViewById(R.id.btn_bd_persegi_back);
        Button btnCalculate = findViewById(R.id.btn_bd_persegi_calculate);
        ...
        btnCalculate.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if (et_input.getText().toString().isEmpty()){
                    Toast.makeText(bd_persegi.this, "Input tidak valid!", Toast.LENGTH_SHORT).show();
