...
public class br_kubus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_br_kubus);
        Vibrator v = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);

        et_input = findViewById(R.id.et_br_kubus_input1);
        et_output = findViewById(R.id.et_br_kubus_output);
        et_output_1 = findViewById(R.id.et_br_kubus_output_1);

        btnBack = findViewById(R.id.btn_br_kubus_back);
        btnCalculate = findViewById(R.id.btn_br_kubus_calculate);
        ...
        btnCalculate.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if (et_input.getText().toString().isEmpty()){
                    Toast.makeText(br_kubus.this, "Input tidak valid!", Toast.LENGTH_SHORT).show();
